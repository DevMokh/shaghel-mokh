...
export const categoryConfig = {
  islamic: { name: "إسلاميات",        fa: "fa-mosque",       subs: ["قصص الأنبياء", "القرآن الكريم", "السيرة النبوية", "الفقه الميسر"],         order: 0 },
  egypt:   { name: "تاريخ مصر",       fa: "fa-landmark",     subs: ["الفراعنة", "مصر الحديثة", "آثار النوبة", "ثورات مصر"],                     order: 1 },
  tech:    { name: "تقنية",           fa: "fa-laptop-code",  subs: ["برمجة", "ذكاء اصطناعي", "أمن سيبراني", "تاريخ الحواسيب"],                  order: 2 },
  science: { name: "علوم وفضاء",      fa: "fa-rocket",       subs: ["الفضاء", "جسم الإنسان", "الكيمياء", "الفيزياء الكمية"],                    order: 3 },
  geo:     { name: "جغرافيا",         fa: "fa-globe-africa", subs: ["عواصم", "أعلام", "عجائب الدنيا", "تضاريس الأرض"],                          order: 4 },
  sports:  { name: "رياضة",           fa: "fa-futbol",       subs: ["كرة قدم", "أساطير", "الأولمبياد", "كأس العالم"],                           order: 5 },
  puzzles: { name: "ألغاز",           fa: "fa-puzzle-piece", subs: ["منطق", "أحجيات", "رياضيات", "ذكاء بصري"],                                  order: 6 },
  food:    { name: "طعام",            fa: "fa-utensils",     subs: ["أطباق عالمية", "حلويات", "توابل", "فواكه نادرة"],                           order: 7 },
  cairo:   { name: "أحياء القاهرة",   fa: "fa-city",         subs: ["وسط البلد", "المعادي والزمالك", "الإسكندرية", "مدن جديدة"],                 order: 8 },
  words:   { name: "كلمات مصرية",     fa: "fa-comments",     subs: ["أمثال شعبية", "كلمات قبطية", "عامية قديمة", "ألقاب ومسميات"],              order: 9 },
  music:   { name: "موسيقى وأغاني",   fa: "fa-music",        subs: ["أغاني الزمن الجميل", "فيروز وأم كلثوم", "نجوم الـ 80s", "مهرجانات"],      order: 10 },
  cinema:  { name: "سينما وتليفزيون", fa: "fa-film",         subs: ["أفلام الـ 90s", "نجوم الشاشة", "مسلسلات رمضان", "كلاكيت زمان"],           order: 11 },
};
